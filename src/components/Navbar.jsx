      ...
      <div>
        <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-200">
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
            <li>
              <a
                className="text-base text-gray-500 hover:text-black font-semibold px-3"
                href="/"
              >
                Home
              </a>
          ...
          <a
            className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold border border-black rounded-lg transition duration-200"
            href="#/"
          >
            Sign In
          </a>
          <a
            className="hidden lg:inline-block py-2 px-6 bg-black hover:bg-gray-600 text-sm text-white font-bold rounded-lg transition duration-200"
            href="#/"
          >
            Sign up
          </a>
